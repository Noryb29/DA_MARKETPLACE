...
const FarmerSidebar = ({ onLogout }) => {
  const [collapsed, setCollapsed] = useState(false)
  const location = useLocation()

  return (
    <aside className={`bg-green-900 min-h-screen text-white flex flex-col transition-all duration-200 shrink-0 ${collapsed ? 'w-16' : 'w-56'}`}>
