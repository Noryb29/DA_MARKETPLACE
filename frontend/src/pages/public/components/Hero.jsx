  ...
  return (
    <section className="bg-linear-to-r from-green-900 to-green-700 text-white py-24 px-8 text-center mb-8">
      <div className="hero-content">
        ...
        <Link to={"/shop/dashboard"}><button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded transition-colors transform hover:-translate-y-0.5 hover:shadow-lg">
          Shop Now
        </button>
        </Link>
      </div>
